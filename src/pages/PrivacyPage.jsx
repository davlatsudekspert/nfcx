  ...
  uz: {
    ...
    sections: [
      ...
      { h: "Ma'lumot yuboriladigan xizmatlar", list: [
        ...
        "Google Gemini — yuklangan rasmlarni avtomatik tekshirish.",
        "Anthropic (Claude) yoki Google Gemini — saytdagi yordamchi: siz yozgan savol faqat javob tayyorlash uchun yuboriladi.",
      ...
      { h: "Ma'lumotlar qayerda saqlanadi va chegaradan tashqariga uzatish", p: "Ma'lumotlar bazasi va yuklangan fayllar Cloudflare, Inc. (AQSh) serverlarida saqlanadi. Qonunning 27¹-moddasiga ko'ra O'zbekiston hududida saqlanishi majburiy bo'lgan biometrik va genetik ma'lumotlar NFCSTORE tomonidan yig'ilmaydi. Ilovadagi barmoq izi yoki yuz bilan qulfni ochish telefonning o'z tizimida bajariladi — biometrik ma'lumot bizga yuborilmaydi va saqlanmaydi. Boshqa ma'lumotlar Vazirlar Mahkamasining 2026-yil 29-iyuldagi 415-son qarori bilan tasdiqlangan, shaxsga doir ma'lumotlarning teng darajada himoyasini ta'minlovchi xorijiy davlatlar ro'yxati asosida chet elda saqlanadi: AQSh bu ro'yxatga EI–AQSh «Data Privacy Framework» dasturi ishtirokchilari uchun kiritilgan, Cloudflare esa shu dastur ishtirokchisi. Boshqa xizmat ko'rsatuvchilarning (Google, Anthropic, Resend, Telegram) serverlari ham O'zbekistondan tashqarida bo'lishi mumkin; ularga ma'lumot faqat ushbu siyosatda yozilgan maqsadlarda va zarur hajmdagina uzatiladi. Ro'yxatdan o'tishda siz bunga rozilik berasiz." },
  ...
  ru: {
    ...
    sections: [
      ...
      { h: 'Сервисы, которым передаются данные', list: [
        ...
        'Google Gemini — автоматическая проверка загружаемых фото.',
        'Anthropic (Claude) или Google Gemini — помощник на сайте: ваш вопрос отправляется только для подготовки ответа.',
      ...
      { h: 'Где хранятся данные и трансграничная передача', p: 'База данных и загруженные файлы хранятся на серверах Cloudflare, Inc. (США). Биометрические и генетические данные, которые по статье 27¹ Закона обязательно хранятся на территории Узбекистана, NFCSTORE не собирает. Разблокировка приложения отпечатком пальца или лицом выполняется системой телефона — биометрические данные нам не передаются и не хранятся. Остальные данные хранятся за рубежом на основании перечня иностранных государств, обеспечивающих равноценную защиту персональных данных, утверждённого постановлением Кабинета Министров от 29 июля 2026 года № 415: США включены в перечень для участников программы EU–U.S. Data Privacy Framework, а Cloudflare — её участник. Серверы других поставщиков услуг (Google, Anthropic, Resend, Telegram) также могут находиться за пределами Узбекистана; им передаются только данные, необходимые для целей, указанных в этой политике. При регистрации вы даёте на это согласие.' },
  ...
  en: {
    ...
    sections: [
      ...
      { h: 'Service providers', list: [
        ...
        'Google Gemini — automatic checking of uploaded photos.',
        'Anthropic (Claude) or Google Gemini — the website assistant: your question is sent only to prepare the answer.',
      ...
      { h: 'Where data is stored and cross-border transfer', p: 'The database and uploaded files are stored on servers of Cloudflare, Inc. (USA). NFCSTORE does not collect biometric or genetic data, which under Article 27¹ of the Law must be stored in Uzbekistan. Unlocking the app with a fingerprint or face is done by the phone’s own system — no biometric data is sent to or stored by us. Other data is stored abroad on the basis of the list of foreign states providing equivalent protection of personal data approved by Cabinet of Ministers Resolution No. 415 of 29 July 2026: the USA is on the list for participants of the EU–U.S. Data Privacy Framework, and Cloudflare is a participant. Servers of other service providers (Google, Anthropic, Resend, Telegram) may also be outside Uzbekistan; only the data needed for the purposes in this policy is sent to them. You consent to this when signing up.' },
