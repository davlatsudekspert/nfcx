...
const CONTENT = {
  uz: {
    ...
    sections: [
      ...
      { h: "Siz yuklagan rasm va videolar", p: "Profil rasmi, muqova, post, story va katalog uchun yuklagan rasm va videolaringiz saqlanadi. Ular OCHIQ profil sahifangizda ko'rinadi va havolaga ega har qanday odam ularni ko'ra oladi — shuning uchun faqat oshkor qilishga tayyor bo'lgan materialni yuklang. Story 24 soatdan keyin avtomatik o'chadi; post va boshqa rasmlar siz o'chirguncha turadi. Ularni istalgan vaqtda ilovadan yoki saytdan o'chirishingiz mumkin, hisobingizni butunlay o'chirish uchun esa qo'llab-quvvatlash xizmatiga murojaat qiling. Yuklangan material uchinchi tomonga sotilmaydi va reklama maqsadida ishlatilmaydi." },
