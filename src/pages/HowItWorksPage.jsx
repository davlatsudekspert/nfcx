...
const STEPS = {
  ...
  ru: [
    ...
    { n: '06', title: 'Подарите', text: 'Если визитка больше не нужна, из кабинета дарите её другому пользователю (по его NFC ID) — бесплатно, при взаимном согласии.' },
    { n: '07', title: 'Успейте до роста цен', text: 'По мере расширения проекта цена на премиум и короткие ID растёт. Пока другие не заняли самые красивые числовые комбинации и редкие NFC ID — сделайте их своими. Текущие цены — лучшее время для покупки.' },
  ],
  en: [
    ...
    { n: '06', title: 'Give it as a gift', text: 'If you no longer need the card, from your dashboard you gift it to another user (via their NFC ID) — free of charge, with mutual consent.' },
    { n: '07', title: 'Act before prices rise', text: 'As our project grows, the price of premium and short IDs goes up. Before others reserve the most beautiful number combinations and rare NFC IDs, make them yours. Today’s prices are the best time to buy.' },
  ],
};
...
const HEADER = {
  uz: {
    ...
    sub: "NFCSTORE orqali shaxsiy raqamli tashrif qog'ozi olish olti qadamdan iborat — bandlashdan tortib uni sovg'a qilish yoki auksionda qatnashishgacha.",
  ...
  ru: {
    ...
    sub: 'Получить личную цифровую визитку через NFCSTORE — это шесть шагов: от бронирования до подарка или участия в аукционе.',
    demoName: 'ВАШЕ ИМЯ',
    cta: 'Посмотреть цены',
  },
  en: {
    ...
    sub: 'Getting a personal digital card through NFCSTORE takes six steps — from reserving it to gifting it or taking part in an auction.',
    demoName: 'YOUR NAME',
    cta: 'See pricing',
  },
};
