...
const STEPS = [
  { n: '01', title: 'Kodni tanlang va tekshiring', text: "3 harf + 2 raqamdan iborat vizitkangizni kiriting (masalan ABZ07) — bo'sh yoki bandligini shu zahoti ko'rasiz." },
    ...
    <main className="wrap">
      <section className="hero" style={{ paddingBottom: 10 }}>
        ...
        <div className="hero-card-stage reveal reveal-3" style={{ padding: '10px 0 0' }}>
          <div className="floaty"><NfcCard code="ABZ07" name="SIZNING ISMINGIZ" finish="black" size="md" /></div>
        </div>
      </section>
