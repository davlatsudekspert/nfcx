  ...
  return (
    <main className="mx-auto w-full max-w-[1800px] px-6 sm:px-10 lg:px-14 pb-16">
      <section className="grid items-center gap-10 pt-14 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          ...
          <h1 className="mt-4 max-w-xl text-4xl font-extrabold leading-tight tracking-tight">
            {t('Barcha band qilingan')} <span className="bg-gradient-to-br from-white to-base-content/50 bg-clip-text text-transparent">{t("raqamli tashrif qog'ozlar")}</span>
          </h1>
      ...
      <section className="mt-16">
        ...
        <h2 className="mt-2 text-2xl font-bold">{t("Barcha raqamli tashrif qog'ozlar")}</h2>
