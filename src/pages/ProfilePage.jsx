    ...
    >
      ...
      >
        ...
        <div className="mt-0.5 flex flex-col items-center">
          ...
          {/* NFC ID — KATTA va TARIF RANGIDA (egasining talabi).
              "nfcstore.uz/" prefiksi olib tashlandi: u har bir profilda
              bir xil bo'lib, faqat joy egallardi va ID ni kichraytirardi.
              Odam eslab qoladigan narsa — ID ning o'zi. */}
          <div
            className="mb-1 mt-1 flex items-center gap-2 font-mono text-[27px] font-extrabold leading-none tracking-[0.1em]"
            style={{ color: tier === 'free' ? 'var(--vz-ink-dim)' : tierColor }}
            title={t('{tier} tarif', { tier: t(TIER_LABEL[tier] || tier) })}
          >
            {tierEmoji && <span className="text-[19px]">{tierEmoji}</span>}
            {record.code}
