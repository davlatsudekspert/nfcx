...
const CONTENT = {
  uz: {
    ...
    ownerK: 'Stiker egasi uchun',
    ownerT: 'Stikerni profilingizga ulash — 1 daqiqa',
    ownerSteps: [
      'Konvertni oching: ichida bir martalik aktivatsiya kodi bor (NF-XXXX-XXXX).',
      'Telefonni stikerga tekkizing — faollashtirish sahifasi o‘zi ochiladi. Yoki nfcstore.uz/activate ga kiring.',
      'Kodni kiriting va tanlang: Shaxsiy yoki Biznes profil.',
      'Ro‘yxatdan o‘ting yoki kiring, stiker qaysi profilni ochishini belgilang va «Faollashtirish»ni bosing.',
      'Tayyor. Endi stikerga tekkizilganda sizning sahifangiz ochiladi. Kod bilan saytdan faollashtirgan bo‘lsangiz, 7 kun ichida stikerga bir marta tekkizing — u shunda bog‘lanadi.',
    ],
  ...
  ru: {
    ...
    ownerK: 'Для владельца наклейки',
    ownerT: 'Подключить наклейку к профилю — 1 минута',
    ownerSteps: [
      'Откройте конверт: внутри одноразовый код активации (NF-XXXX-XXXX).',
      'Приложите телефон к наклейке — страница активации откроется сама. Или зайдите на nfcstore.uz/activate.',
  ...
  en: {
    ...
    ownerK: 'For sticker owners',
    ownerT: 'Link the sticker to your profile — 1 minute',
    ownerSteps: [
