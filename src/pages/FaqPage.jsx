...
const FAQ = {
  ...
  ru: [
    ...
    { q: 'Как выглядит мой профиль?', a: 'У каждой визитки есть своя личная страница: ваше фото, профессия, био, контакты, соцсети (Telegram, Instagram, Facebook, X), номер платёжной карты и выбранная тема дизайна.' },
  ...
  en: [
    ...
    { q: 'What does my profile look like?', a: 'Every card has its own personal page: your photo, profession, bio, contacts, social networks (Telegram, Instagram, Facebook, X), your payment card number and your chosen design theme.' },
