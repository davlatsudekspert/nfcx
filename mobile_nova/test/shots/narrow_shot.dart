...
/// Tor ekrandagi tuzatish KO'RINISHNI buzmaganini ko'rsatadi.
void main() {
  setUpAll(() async {
  ...
  Future<void> shot(
      WidgetTester tester, Size size, Locale locale, String name) async {
    ...
    await tester.pumpWidget(ProviderScope(
      ...
      child: MaterialApp(
        ...
        theme: buildTheme(NfcTokens.ocean),
        locale: locale,
  ...
  testWidgets('home 320 uz',
      (t) => shot(t, const Size(320, 700), const Locale('uz'), 'narrow-uz'));
  testWidgets('home 320 ru',
      (t) => shot(t, const Size(320, 700), const Locale('ru'), 'narrow-ru'));
  testWidgets('home 390 uz',
      (t) => shot(t, const Size(390, 780), const Locale('uz'), 'wide-uz'));
}
