...
/// BOSH MENYUDAGI SAYT KARTASI — KO'RINISH ISBOTI.
///
/// Karta chizilishini `polish_test.dart` tekshiradi; bu yerda
/// uning UCH MAVZUDA ham yamoq bo'lib turmasligi ko'rinadi.
void main() {
  setUpAll(() async {
  ...
  Future<void> shot(WidgetTester tester, NfcTokens t, String name) async {
    ...
    await tester.scrollUntilVisible(find.text(l.siteCardTitle), 200,
        scrollable: find.byType(Scrollable).first);
    // Rasm dekodlash HAQIQIY asinxron I/O — `pump` uni kutmaydi.
    // Busiz birinchi ishga tushgan mavzuda logotip belgisi bo'sh
    // chiqadi (keyingilari iliq keshdan oladi) va surat yolg'on
    // "mavzuga bog'liq xato" ko'rsatadi.
