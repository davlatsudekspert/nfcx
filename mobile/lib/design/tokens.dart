...
class TierStyle {
  const TierStyle(this.light, this.dark, this.label);
  final Color light;
  final Color dark;
  final String label;

  static const map = <Tier, TierStyle>{
    Tier.free: TierStyle(Color(0xFF4A4750), Color(0xFF24222A), 'Free'),
    Tier.bronze: TierStyle(Color(0xFFE0B083), Color(0xFF7D4A1E), 'Bronze'),
    Tier.silver: TierStyle(Color(0xFFEEF2F6), Color(0xFF8B949C), 'Silver'),
    Tier.gold: TierStyle(Color(0xFFF0CF7A), Color(0xFFA87C0D), 'Gold'),
    Tier.premium: TierStyle(Color(0xFFD8C6F0), Color(0xFF6B4FA0), 'Premium'),
    Tier.exclusive: TierStyle(Color(0xFFF6EAD0), Color(0xFF5A4A22), 'Exclusive'),
  };
