...
class NIcon extends StatelessWidget {
  const NIcon(
    ...
    super.key,
    this.size = 24,
    // MAVZUGA BOG'LIQ STANDART. `C.ink` endi palitradan keladi,
    // shuning uchun u `const` standart qiymat bo'la olmaydi.
    // `null` = "matn rangini ol" degani va u `build` da yechiladi.
    this.color,
    this.filled = false,
  });
